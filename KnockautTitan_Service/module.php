<?
    // Klassendefinition
    class KnockautTitanService extends IPSModule {
        ...
        public function Create() {
            ...
            $this->RegisterTimer("AliveCheck", 0, 'KTS_LiveCheck($_IPS[\'TARGET\']);');     // Timer in Millisekunden für den Live Check, hier 0 ms wird in "ApplyChanges" eingestellt
            // Update Check Standard 1x am Tag
            $this->RegisterTimer("UpdateCheck", 0, 'KTS_UpdateCheck($_IPS[\'TARGET\']);');  // Timer in Millisekunden für den Aktuallisierungs Check, hier 0 ms wird in "ApplyChanges" eingestellt
